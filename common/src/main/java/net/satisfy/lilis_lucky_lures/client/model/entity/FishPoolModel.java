...
public class FishPoolModel<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new LilisLuckyLuresIdentifier("fish_pool"), "main");
    ...
    public FishPoolModel(ModelPart root) {
